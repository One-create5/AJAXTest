<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CardMaker.aspx.cs" Inherits="AJAXTest.Pages.CardMaker" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	<asp:ScriptManagerProxy ID="ScriptProxy1" runat="server" />
	<!-- These are the controls for creating the greeting card. -->
	<div style="BORDER-RIGHT: thin ridge; PADDING-RIGHT: 20px; BORDER-TOP: thin ridge; PADDING-LEFT: 20px; FONT-SIZE: x-small; PADDING-BOTTOM: 20px; BORDER-LEFT: thin ridge; WIDTH: 293px; PADDING-TOP: 20px; BORDER-BOTTOM: thin ridge; FONT-FAMILY: Verdana; HEIGHT: 508px; BACKGROUND-COLOR: lightyellow">
		Choose a background color:
		<br />
		<asp:dropdownlist id="lstBackColor" runat="server" Height="22px" Width="194px" AutoPostBack="True"></asp:dropdownlist>
		<br /><br />
		...
		<br />
		<asp:textbox id="txtGreeting" runat="server" Height="85px" Width="240px" TextMode="MultiLine" AutoPostBack="True"></asp:textbox>
		<br /><br />
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			<asp:panel id="pnlCard" 
                ...
                <br />
                <asp:Image id="imgDefault" ImageUrl="~/Images/defaultpic.png" runat="server" Width="212px" Height="160px" Visible="False"></asp:Image>
           </asp:panel>  
        </ContentTemplate>
		<Triggers>
